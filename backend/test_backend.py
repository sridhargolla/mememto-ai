...
def test_hybrid_retrieval_logic():
    ...
    m1 = Memory(type="skill", title="Python Programming", content="Deep expertise in Python scripting and FastAPI development.", user_id=1)
    m2 = Memory(type="project", title="Visual Attendance", content="Face detection project using OpenCV and computer vision.", user_id=1)
