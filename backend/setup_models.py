    ...
    try:
        ...
        if env_path.exists():
            ...
            if "MODEL_PATH" in env_content:
                env_content = env_content.replace("MODEL_PATH=*", f"MODEL_PATH={model_path}")
            else:
            ...
            print("[OK] Updated .env file with MODEL_PATH")
        else:
            print("[WARNING] Please add the following to your .env file:")
        ...
        print("Place it in the 'models/' directory and update MODEL_PATH in .env")
        sys.exit(1)
