...
from memory_schema import Entities, MemorySchema, TimeInfo
...
def test_memory_schema():
    ...
    memory = MemorySchema(
        ...
        time=TimeInfo(start="2020-01-01", end="2023-12-31"),
        importance="high",
    ...
    # Test from JSON
    MemorySchema.from_json(json_str)
    print("✓ Memory reconstructed from JSON")

    # Test validation
    try:
        MemorySchema(type="invalid_type", title="Test", summary="Test summary")
